      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="mt-10 flex justify-center gap-4 flex-wrap">
            ...
            <button
              className="px-7 py-3 rounded-xl font-semibold bg-blue-500 hover:bg-blue-600 text-slate-900
        ...
        <div class="max-w-7xl px-6 py-20 mx-auto">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-sm">
              ...
              <blockquote className="text-gray-700 dark:text-gray-300 text-sm sm:text-base mb-4 sm:mb-6">
