...
export default function Leader() {
  ...
  const fetchLeaders = async () => {
    ...
    try {
      ...
      // Filter atau Map data sesuai kebutuhan
      // Asumsi: Backend mengembalikan semua member, kita filter/map di sini jika perlu
      const formatted = data
        .filter(item => item.jabatan === "leader") // Filter khusus Leader jika perlu
        .map(item => ({
          ...item,
